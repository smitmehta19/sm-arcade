...
const Icons = (() => {
  ...
  const UI = {
    ...
    calendar: wrap('<rect x="3.5" y="5" width="17" height="15.5" rx="2.6"/><path d="M3.5 9.5h17M8 3v4M16 3v4"/><path d="M9.6 14.6c.5-1.5 1.5-2.3 2.4-2.3s1.9.8 2.4 2.3c-.5 1.5-1.5 2.3-2.4 2.3s-1.9-.8-2.4-2.3z" ' + fc + '/>'),
    gear: wrap('<circle cx="12" cy="12" r="3.1"/><path d="M12 2.8l1 2.4a7 7 0 012.3 1l2.5-.8 1.8 3.1-1.6 2a7 7 0 010 2.9l1.6 2-1.8 3.1-2.5-.8a7 7 0 01-2.3 1l-1 2.4h-0l-1-2.4a7 7 0 01-2.3-1l-2.5.8-1.8-3.1 1.6-2a7 7 0 010-2.9l-1.6-2 1.8-3.1 2.5.8a7 7 0 012.3-1z"/>'),
  };
